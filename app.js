                                    ...
                                    mysql_connection.query("INSERT INTO users (first_name, last_name, username, email, password, user_bio, profile_picture) VALUES (?, ?, ?, ?, ?, ?, ?)", [FirstName, LastName, username, email, hash, bio, profile_picture], function (err, rows) {
                                        if(err){
                                            ...
                                            if(rows.affectedRows === 1){
                                                ...
                                                sendMessage('postmaster@ddrguy2.juliowebmaster.com', 'shishio1', '"Postmaster" <postmaster@ddrguy2.juliowebmaster.com>', email, 'Registration Notification', 'Sample text here', 'ddrguy2 registration', 'Registration Notification', FirstName, 'Thank you for registering with us at ddrguy2.', 'Your account is ready to go.');
